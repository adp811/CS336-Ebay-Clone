...
<body>
    <nav style="display:flex;position:sticky;top:0;padding:10px;background:black;margin-bottom:10px;color:white;">
        ...
        <a href="UserHistory.jsp" style="color:unset;margin-left:10px;">User Lookup</a>
    ...
    %>
        ...
        <form id="searchForm">
            ...
            <select id="searchCategory">
                ...
                <option value="itemSubcategory">Item Sub-Category</option>
            </select>
        ...
        try{
            ...
            String searchFormQuery = (String)request.getParameter("q");
            String searchFormCategory = (String)request.getParameter("category");
            
            String str = "";
            
            
            //if doesnt work uncomment this below
            //String str = "SELECT listing_id, itemName, itemImageURL, itemStartingPrice, itemCloseDate FROM listing ORDER BY itemCloseDate";
            
            
            //if doesnt work add multiline comment starting here
            if(searchFormQuery == null && searchFormCategory == null) { //initial loading            
            
                str = "SELECT listing_id, itemName, itemImageURL, itemStartingPrice, itemCloseDate FROM listing ORDER BY itemCloseDate";
               	//out.print(str);    
            
            } else {
                
                if (searchFormQuery.equals("") || searchFormCategory.equals("browse")){ //not bounded to any category
                    
                    str = "SELECT listing_id, itemName, itemImageURL, itemStartingPrice, itemCloseDate FROM listing ORDER BY itemCloseDate";
                    //out.print(str);    
                
                } else if (!searchFormQuery.equals("") && searchFormCategory.equals("itemBrand")) {
                    
                    str = "SELECT listing_id, itemName, itemImageURL, itemStartingPrice, itemCloseDate FROM listing WHERE itemBrand LIKE '%" + searchFormQuery + "%' ORDER BY itemCloseDate";
                    //out.print(str);
                    
                } else if (!searchFormQuery.equals("") && searchFormCategory.equals("itemName")) {
                    
                    str = "SELECT listing_id, itemName, itemImageURL, itemStartingPrice, itemCloseDate FROM listing WHERE itemName LIKE '%" + searchFormQuery + "%' ORDER BY itemCloseDate";
                    //out.print(str);
                    
                } else if (!searchFormQuery.equals("") && searchFormCategory.equals("itemDescription")) {
                    
                    str = "SELECT listing_id, itemName, itemImageURL, itemStartingPrice, itemCloseDate FROM listing WHERE itemDescription LIKE '%" + searchFormQuery + "%' ORDER BY itemCloseDate";
                    //out.print(str);
                    
                } else if (!searchFormQuery.equals("") && searchFormCategory.equals("itemSubcategory")) {
                    
                    str = "SELECT listing_id, itemName, itemImageURL, itemStartingPrice, itemCloseDate FROM listing WHERE itemSubcategory LIKE '%" + searchFormQuery + "%' ORDER BY itemCloseDate";
                    //out.print(str);
                    
                } /* else if (!searchFormQuery.equals("") && searchFormCategory.equals("all_cat")) {
                    
                    str = "SELECT listing_id, itemName, itemImageURL, itemStartingPrice, itemCloseDate FROM listing WHERE itemName LIKE  ORDER BY itemCloseDate";
